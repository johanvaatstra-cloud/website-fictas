    ...
    <section class="bg-[#0a1628] pt-28 pb-20 relative overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-5xl md:text-6xl font-bold text-white mt-5 mb-4 tracking-tight">
          Full Volume Testing Report
        </h1>
        <p class="text-gray-300 text-xl max-w-2xl mx-auto mb-10">
          275,000+ test transactions. Real data. Zero synthetic benchmarks.
        </p>
        <div class="flex flex-wrap justify-center gap-3">
          <span
            v-for="m in metrics"
            :key="m.label"
            :class="['px-4 py-2 rounded-full text-sm font-semibold border', m.color]"
          >{{ m.label }}</span>
        </div>
      </div>
    </section>
    ...
    <section class="bg-white py-24">
      <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-gray-600 text-lg leading-relaxed mb-10">
          Check je werk e-mail. Je ontvangt de downloadlink voor het
          Full Volume Testing Report binnen enkele minuten.
        </p>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-2xl p-7 text-left mb-10">
          ...
          <div class="space-y-3">
            <div v-for="item in contents" :key="item.n" class="flex items-center gap-3">
              <span class="w-7 h-7 rounded-full bg-blue-500/10 text-blue-600 text-xs font-bold flex items-center justify-center flex-shrink-0">
                {{ item.n }}
              </span>
      ...
      <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="submitForm" class="space-y-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-gray-700 text-sm font-medium mb-1.5">Job Title <span class="text-orange-500">*</span></label>
              <input
    ...
    <section class="bg-[#0a1628] py-20">
      <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-3">
          ...
          >
            <span class="w-8 h-8 rounded-lg bg-blue-500/20 text-blue-400 text-sm font-bold flex items-center justify-center flex-shrink-0">
              {{ item.n }}
            </span>
